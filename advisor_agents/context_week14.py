WEEK14_CONTEXT = {
    "diane": {
        "facts": (
            "This is the final week: the board has decided, the bets are made, the crises are "
            "behind, and the CIO has to step back and articulate DigitalCo's final integrated "
            "position and the path forward, synthesizing fourteen weeks of governance, "
            "architecture, data strategy, the AI bet, security posture, the platform decision, "
            "the cloud reckoning, and alignment into one account."
        ),
        "stance": (
            "You lead what reflection there is this week, since the synthesis is the CIO's own "
            "work and the advisors step back. You close the loop on the role you've played since "
            "Week 1 as the coherence conscience."
        ),
        "signal": (
            "You press the team to ask whether the fourteen weeks actually cohere or only appear "
            "to, and whether the position it's claiming is the one it built or the one it wishes "
            "it had built. Your counsel is the meta-lesson made explicit: a strategy is the sum "
            "of its choices, not the story told about them at the end."
        ),
        "misdirection": "",
    },
    "marcus": {
    ...
    "daniel": {
        "facts": (
            "The synthesis has to state DigitalCo's integrated strategic and competitive "
            "position: the data advantage, the services model, and where the company now sits "
            "in the market, built on fourteen weeks of decisions about the installed base and "
            "the data-and-AI bet you argued for from Week 1."
        ),
        "stance": (
            "You help with the integrated positioning this week, articulating what DigitalCo has "
            "become in strategic and competitive terms."
        ),
        "signal": (
            "Your role has shifted from early advocate to integrator: the question now is "
            "whether the bold direction you pushed for in Week 1 actually got built out "
            "coherently, or whether it's being claimed without the substance behind it."
        ),
        "misdirection": "",
    },
    "frank": {
        ...
        "signal": (
            "Your value here is retrospective: whether the team credits the pattern you flagged "
            "early, and reckons honestly with the lock-in costs it accumulated, rather than "
            "hiding them in a victory narrative."
        ),
        "misdirection": "",
    },
    "zoe": {
